...
__author__ = "Sitong An <sa747@cam.ac.uk>"
...
gen_method = genvlist_itrAd	#generation method
...
def main():
	...
	vlist_all=file2list(mother_list)
	...
	print "vSearch : Initial vlist = " + str(vlistlist_curr)
	...
	while(gen <=endgen):
		...
		joblist=spawnvlist(headerline, vlist_all)
...
def spawnvlist(headerline, vlist_all):
	...
	nextfileid = 1
	nextgenvlistlist = []
	for vlist_curr in vlistlist_curr:
		...
		for idx, eachfile in enumerate(out):
